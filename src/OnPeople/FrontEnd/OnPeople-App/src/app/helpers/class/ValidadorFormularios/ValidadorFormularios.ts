...
export class ValidadorFormularios {
  static compararArgumentos(argumento: string, confirmarArgumento: string): any {
    return (group: AbstractControl): any => {
      const formGroup = group as FormGroup;
      const control = formGroup.controls[argumento];
      const matchingControl = formGroup.controls[confirmarArgumento];
  ...
  static retornarMensagem(nomeCampo: FormControl, elementoCampo: string): any {
