...
import { DadoPessoal } from 'src/app/employees/models';
import { PersonalDocumentsService } from 'src/app/employees/services';
...
export class PersonalDocumentsComponent implements OnInit {
  ...
  public saveChange(): void {
    ...
    console.log("Address", this.personalDocument)
