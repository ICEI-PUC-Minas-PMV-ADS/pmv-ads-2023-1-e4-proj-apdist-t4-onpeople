...
import { DadoPessoal, Endereco, Funcionario } from 'src/app/employees/models';
import { EmployeeService } from 'src/app/employees/services';
import { AddressService } from 'src/app/employees/services/address.service';
import { PersonalDocumentsService } from 'src/app/employees/services/personalDocuments.service';
...
//      dataEncerramento: []
  ...
  public changeSelectDepartment(): void {
    ...
    console.log("selectDepartmentId",this.selectDepartmentId, this.selectCompanyId)
  ...
  public changeSelectJobRole(): void {
    ...
    console.log("selectJobRoleId", this.selectJobRoleId, this.selectCompanyId)
    this.jobRoleService
      ...
      .subscribe(
        (jobRole: Cargo) => {
          ...
          console.log("changeSelectJobRole", this.jobRole)
        },
        (error: any) => {
          this.toastrService.error(error.error, `Erro! Status ${error.status}`)
          console.log(error)
  ...
  public changeSelectUserName(): void {
    ...
    console.log("selectUserNameId",this.selectUserNameId, this.selectCompanyId)
    this.userService
      ...
      .subscribe(
        (user: Users) => {
          ...
          console.log("changeSelectUserName", this.user)
        },
        (error: any) => {
          this.toastrService.error(error.error, `Erro! Status ${error.status}`)
          console.log(error)
    ...
    this.userService
      ...
      .subscribe(
        (users: Users[]) => {
          ...
          console.log("NomeCargo", this.jobRole.nomeCargo)
  ...
  public getEmployee(): void {
    ...
    console.log('Id', this.employeeParm)
  ...
  public createEmployee(): void {
    ...
    this.employee.ativo = true;
     ...
     console.log("Funcioanrio", this.employee)
    ...
    .subscribe(
      (employeeCreated: Funcionario) => {
        ...
        console.log("Create employee", this.employee, this.selectVisao)
...
//    this.user.visao = this.selectVisao;
    ...
    console.log("Update User", this.user, "phoneNumber", this.ctrF.phoneNumber.value)
    this.userService
  ...
  public updateEmployee(): void {
    ...
    console.log("updateEmploee", this.employee)
    this.employeeService
